...
function multipurpose_shop_enqueue_child_styles() {
	...
	wp_enqueue_script( 'jquery-js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js', 0, '', true );
	wp_enqueue_script( 'index-js', get_stylesheet_directory_uri( ).'/js/index.js', 0, '', true );
	}
