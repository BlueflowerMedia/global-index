...
== Tags ==
one-column, two-columns, right-sidebar, custom-background, custom-menu, featured-images, theme-options, translation-ready, custom-logo, e-commerce

== Copyright ==

Multipurpose Shop WordPress Theme, Copyright (C) 2017 eDataStyle ( proscriptsell )
Multipurpose Shop is distributed under the terms of the GNU GPL.
...
== Image ==
* https://www.pexels.com/photo/working-macbook-computer-keyboard-34577/ ( CC0 License )

== Changelog ==

= 1.5 =
* preview sidebar issue 
